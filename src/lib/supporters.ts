...
export type Barony = {
  dignity: "Baron" | "Lord Baron" | "Earl" | "Younger" | "Lord & Steward" | "Countess" | "Baroness" | "Herald";
  name: string;
  img?: string;
  note?: string;
...
export const baronies: Barony[] = [
  ...
  { dignity: "Baron", name: "Winchburgh", roll: "https://roll.baronage.com/baron/michael-lyons", img: "/arms/winchburgh-arms-v2.webp", pageOnly: true },
  ...
  { dignity: "Earl", name: "Rothes", roll: "https://roll.baronage.com/dario-item.html", img: "/arms/rothes.webp", pageOnly: true },
