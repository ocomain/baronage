...
export type Barony = {
  dignity: "Baron" | "Lord Baron" | "Earl Lord Baron" | "Younger" | "Lord & Steward" | "Countess" | "Baroness";
  name: string;
  img?: string;
  note?: string;
...
export const baronies: Barony[] = [
  ...
  { dignity: "Earl Lord Baron", name: "Rothes", roll: "https://roll.baronage.com/dario-item.html", img: "/arms/rothes.webp", pageOnly: true },
