    ...
    <div className="marquee py-2">
      <div className="marquee__track">
        {row.map((b, i) => (
          <figure
            key={`${b.slug}-${i}`}
            className="group mr-6 flex w-56 shrink-0 flex-col items-center rounded-sm border border-parchment-300/70 bg-parchment-50 px-6 pb-6 pt-8 text-center shadow-[0_18px_40px_-30px_rgba(10,16,36,0.5)] transition-colors duration-300 hover:border-gold"
