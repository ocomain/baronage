...
const members: CouncilMember[] = [
  ...
  },
  {
    ...
    pos: "center 18%",
    popPos: "center 14%",
    bio: "Antoin Commane, Younger of Kinfauns is heir to the chiefship of Ó Comáin and lordship of Kinfauns — a dignity granted by Robert the Bruce for the pirate-knight Sir Thomas de Longueville around 1330, regranted for his descendant Sir William Charteris by James III in 1487. Kinfauns is Tanist of Clan Ó Comáin, heir to the Chief, an ancient Gaelic Royal House and Irish clan recognised under the patronage of the President of Ireland. From the family seat at Newhall, County Clare, the family are custodians of Killone Abbey and the Holy Well of St John the Baptist. The lordship is pledged as a hereditary title upon the Roll.",
  },
  {
    mark: "M",
...
const stewardship = [
  ...
  },
  {
    ...
    body: "A Scottish Registered Solicitor, one of Scotland's leading genealogists, researchers, scholars and a Chief of the Name who have held a barony in their family for 700 years — who vet and verify entries with accuracy and legal precision.",
  },
  {
    numeral: "III",
