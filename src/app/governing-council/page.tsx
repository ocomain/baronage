...
const stewardship = [
  ...
  },
  {
    ...
    body: "A Scottish Registered Solicitor, one of Scotland's leading genealogists, researchers, scholars and a Chief of the Name who have held a barony in their family for 800 years — who vet and verify entries with accuracy and legal precision.",
  },
  {
    numeral: "III",
