...
export const metadata: Metadata = {
  ...
  description:
    "An open, verified and impartial public register of the Baronage of Scotland — free, for life, to verify an entry. Maintained by researchers, genealogists and scholars.",
};
  ...
  return (
    <>
          ...
          <Reveal>
            <div className="prose-heritage mt-8">
              ...
              <p>
                ...
                titles is fundamental to our work. Cooperating organisations and barons agree not to recognise the
                title, honour, rank and status of “baron of” — or any higher dignity — for unverified holders.
              </p>
            </div>
          </Reveal>
      ...
      <Section tone="navy" className="text-center">
        <Container size="prose">
          <Reveal>
            <Eyebrow light>Verify a Title</Eyebrow>
            <h2 className="mt-4 text-3xl text-parchment-50 sm:text-4xl">Have an entry verified on the Roll</h2>
            <GoldRule className="mt-7" />
            <p className="mx-auto mt-7 max-w-xl leading-relaxed text-parchment-200/85">
              A small team of researchers, genealogists and scholars keeps the Roll. To verify a pledged or non-pledged
              entry — free, for life — please contact the Secretary.
            </p>
