    ...
    body: (
      <>
        <p>
          ...
          barons — only the earls are styled by dignity, together with the lordships of “Jacobus{" "}
          <em>Dominus de</em> Duglas” and “Dauid <em>Dominus de</em> Brechyn” (and Moray’s lordship of Man and
          Annandale), the other barons appearing by name alone; and the descent of those lordships, Douglas above
          all, shows the lord’s title already running as a hereditary rank. Whether “baron” was a name of dignity
