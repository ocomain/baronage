    ...
    body: (
      <>
        <p>
          ...
          1943 the Court of the Lord Lyon found and declared that the minor barons “are, and have been” recognised
          as a <strong className="font-semibold text-navy">“titled nobility”</strong> (see{" "}
        ...
        <p className="mt-4">
          ...
          rank and status of a free baron”. The{" "}
    ...
    body: (
      <>
        <p>
          ...
          <strong className="font-semibold text-navy">“Baron of [the barony]”</strong> and grant arms with additaments and a
          helmet befitting their degree. In recent years, the Lord Lyon routinely treats an entry
        ...
        <p className="mt-4">
          The dignity itself is held as of right under s. 63 of the 2000 Act. In{" "}
          <em>Hamilton of Rockhall v Lord Lyon</em> [2019] CSOH 85 the Court of Session said a grant of arms is{" "}
          <em>“only ever a matter of grace (and not entitlement)”</em>. That was said of arms, not of the title. The
          court did not decide whether a baron is entitled to be recognised as a baron. The Lord Lyon has also said
          that{" "}
        ...
        <p className="mt-4">
          ...
          none can bind his successor”</em> (para 39).
        </p>
      </>
    ),
    authority: (
