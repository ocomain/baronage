    ...
    body: (
      <>
        <p>
          ...
          <strong className="font-semibold text-navy">the “feudal baron” is now defunct</strong>.
        </p>
        <p className="mt-4">
          ...
          statute, not custom, settles the terminology.
        </p>
        <p className="mt-4">
